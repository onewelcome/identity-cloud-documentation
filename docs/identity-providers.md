...
As an organization your want to give your end-users the freedom to choose how they want to sign in to your applications. You can do that with (fedarated) Identity Providers (IdP). These pages will provide you with the basic understanding on how various Identity Providers connect to the Onegini Identity Cloud.
...
- You can add connections to predefined federated Identity Providers that are active in our primary markets. Following link contains a [complete list of the Identity Providers that we support](https://www.onegini.com/knowlegde/apis-integrations#identity_proofing).
...
- **Identity Proofing:** The Onegini Identity Cloud allows you to store a score that represents how sure your are about the real-life identity of an end-user. This gives you a complete overview on how and when a user provided information about their real-life identity.
