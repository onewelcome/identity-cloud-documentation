...
| hashed_client_secret             | depends  | "$bcrypt$c=12$T/jBeKR…"                       | A hashed version of the secret using the PHC format (not returned on GET). For more information, see the [Web Client Migration](../../topics/web-clients/web-client-migration.md) page.                                                                                                         
