...
Supported Identity Provider types: `ID_BROKER`, `TULIP`, `OAUTH`
...
| issuer_uri                   | ID_BROKER, TULIP        | yes      | Uri of the issuer. This URI will be used to read the OpenID Connect configuration.                                                                                                                                      |
| client_id                    | ID_BROKER, TULIP, OAUTH | yes      | Client identifier.                                                                                                                                                                                                      |
...
| scopes                       | ID_BROKER, TULIP, OAUTH | no       | Space-separated scopes.                                                                                                                                                                                                 |
