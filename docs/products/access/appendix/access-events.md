...
| ADMIN DUM ENGINE CONFIG CREATED                               | DUM Engine configuration has been added via the admin console.                                                                                                                                        |
| ADMIN DUM ENGINE CONFIG UPDATED                               | DUM Engine configuration has been modified via the admin console.                                                                                                                                     |
| ADMIN DUM ENGINE CONFIG DELETED                               | DUM Engine configuration has been removed via the admin console.                                                                                                                                      |
...
| API DUM ENGINE CONFIG LISTED                                | A list of DUM Engine Configuration was returned via the API.                                                                          |
| API DUM ENGINE CONFIG NOT FOUND                             | An attempt was made to read, update or delete an DUM Engine Configuration via the API, but no configuration exists with the given id. |
| API DUM ENGINE CONFIG CREATED                               | A DUM Engine Configuration has been created via the API.                                                                              |
| API DUM ENGINE CONFIG UPDATED                               | A DUM Engine Configuration was updated via the API.                                                                                   |
| API DUM ENGINE CONFIG DELETED                               | A DUM Engine Configuration was deleted via the API.                                                                                   |
| API DUM ENGINE CONFIG ALREADY EXISTS                        | An attempt was made to create an DUM Engine Configuration via the admin API , but a different configuration with the same id already exists.|
