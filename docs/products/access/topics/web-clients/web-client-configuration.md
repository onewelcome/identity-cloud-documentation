...
| Group permissions version         | no       |                     | By default, the latest version of the DUM report is returned in claims. Change the default to legacy if your application depends on the legacy version 1 of this report.
