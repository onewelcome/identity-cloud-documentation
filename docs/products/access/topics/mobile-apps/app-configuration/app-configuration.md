...
| DUM engine configuration             | no       | myDumConfig         | Configuration of DUM (Delegated User Management) that should be used to gather person report containing information about group memberships and permissions.
